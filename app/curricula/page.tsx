...
export default function CurriculaPage() {
  return <main className="curricula-page">
    <header className="curricula-nav"><div className="curricula-brand"><BrandLogo /></div><Link href="/how-it-works">See how it works <ArrowRight size={15} /></Link></header>
    <section className="curricula-hero"><p><Layers3 size={15} /> CURRICULUM INTELLIGENCE</p><h1>One learning engine.<br /><em>Many curricula.</em></h1><span>Trussline is designed for international learning without flattening the systems learners, families, and teachers already know.</span></section>
    <section className="curricula-principle"><Route size={21} /><div><p>THE ARCHITECTURE PROMISE</p><h2>Keep each curriculum distinct. Keep learning consistent.</h2><span>Each activity can reflect the right curriculum, level, goal, skills, and context. The same learning engine helps learners practise, show their thinking, and decide what to do next.</span></div></section>
    ...
    <section className="curricula-end"><p>TRUSSLINE INTERNATIONAL</p><h2>A global platform that<br />takes local learning seriously.</h2><Link href="/about">Read more <ArrowRight size={16} /></Link></section>
  </main>;
}

...
export default function HowItWorksPage() {
  ...
  return <main className="experience-page">
    <header className="experience-nav"><div className="experience-brand"><BrandLogo /></div><Link href="/" className="experience-back"><ChevronLeft size={15} /> Home</Link></header>
    <section className="experience-intro"><p><Sparkles size={14} /> THE INTERACTIVE LEARNING ENGINE</p><h1>Learning changes<br />when the <em>next step</em> listens.</h1><span>Trussline turns curriculum goals into activities that help learners reason, show their thinking, and get useful help as they work.</span></section>
    <section className="experience-loop" aria-label="How the learning loop works">
      ...
      <article><b>03</b><Sparkles size={19} /><h2>Respond with care</h2><p>The companion suggests one helpful thing to try, based on the learner’s work so far.</p></article>
    </section>
